...
class View
{
    ...
    {
        if ($data) {
            // recorre cada uno de los elementos del array asociativo $data que pasamos como argumento
            foreach ($data as $key => $value) {
                // cada elemento lo inserta como una propiedad del objeto $Vista
                // y cada propiedad contendrá los datos de cada elemento del array
                $this->{$key} = $value;
            }
        }
